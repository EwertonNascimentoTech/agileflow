...
from app.modules.crm.models import ProposalStatus, ContractStatus
...
from app.modules.crm.service_proposals import (
    ProposalService, ProposalTemplateService,
    ContractService, ContractTemplateService,
)


router = APIRouter(prefix="/crm", tags=["Propostas e Contratos"])

# Context do módulo
_ctx = require_module("crm")

_can_create = require_permission("crm.proposal.create")
_can_update = require_permission("crm.proposal.update")
_can_send   = require_permission("crm.proposal.send")
_can_accept = require_permission("crm.proposal.accept")
_can_delete = require_permission("crm.proposal.delete")
_can_template = require_permission("crm.template.manage")
_can_contract = require_permission("crm.contract.manage")
_can_sign     = require_permission("crm.contract.sign")
...
async def proposals_metrics(ctx: ModuleContext = Depends(_ctx)):
    ...
    """
    from app.modules.crm.service_proposals import ProposalsMetricsService
