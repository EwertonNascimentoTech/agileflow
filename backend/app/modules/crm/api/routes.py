...
from app.modules.crm.models import ChannelType, ClientType

# Pré-instanciados (pequena otimização — FastAPI resolve a mesma instância)
_can_config         = require_permission("crm.config.manage")
_can_client_manage  = require_permission("crm.client.manage")
_can_company_manage = require_permission("crm.company.manage")
_can_task_manage    = require_permission("crm.task.manage")
_can_attendance_create = require_permission("crm.attendance.create")
_can_attendance_update = require_permission("crm.attendance.update")
_can_attendance_assign = require_permission("crm.attendance.assign")
_can_timeline_manage   = require_permission("crm.timeline.manage")
_can_automation_manage = require_permission("crm.automation.manage")
_can_followup_manage   = require_permission("crm.followup.manage")
_can_reports_view      = require_permission("crm.reports.view")
...
from app.modules.crm.models import TaskStatus, AutomationTrigger
...
async def funnel_metrics(funnel_id: uuid.UUID, ctx: ModuleContext = Depends(_ctx)):
    ...
    """
    from app.modules.crm.service import MetricsService
