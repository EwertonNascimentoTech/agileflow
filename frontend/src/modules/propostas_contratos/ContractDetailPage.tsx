...
import { contractsApi } from "@/api/propostasContratos"
import type { Contract, ContractStatus, ContractSign } from "@/api/propostasContratos"
  ...
  return (
    <div className="space-y-4 max-w-4xl">
      <div className="flex items-center gap-3 flex-wrap">
        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => navigate("/app/modules/propostas_contratos/contracts")}>
          <ArrowLeft size={15} />
        </Button>
          ...
          {contract.proposal_id && (
            <Card>
              <CardContent className="p-3 text-sm">
                <button
                  onClick={() => navigate(`/app/modules/propostas_contratos/proposals/${contract.proposal_id}`)}
