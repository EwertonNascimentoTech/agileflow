...
import type { Proposal } from "@/api/propostasContratos"
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="no-print sticky top-0 z-10 bg-white border-b flex items-center justify-between px-6 py-3">
        <a href={`/app/modules/propostas_contratos/proposals/${proposal.id}`} className="text-sm text-muted-foreground hover:text-foreground">
          ← Voltar
        </a>
