...
import { KanbanSquare, Users, Building2, Settings2, BarChart3, TrendingUp, GitBranch, ClipboardList, DollarSign, FileText, FileSignature } from "lucide-react"
...
const tabs = [
  ...
  { to: "/app/modules/crm/config",       icon: Settings2,    label: "Config" },
]
