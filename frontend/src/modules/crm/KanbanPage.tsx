...
import { statusConfigApi, attendancesApi, clientsApi, funnelsApi } from "@/api/crm"
import type { StatusConfig, AttendanceSummary, ClientSummary, Priority, ChannelType, Funnel } from "@/api/crm"
  ...
  if (funnels.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center text-muted-foreground space-y-3">
        ...
        <Button size="sm" onClick={() => navigate("/app/modules/crm/config/funnels")}>
          Configurar Funis
        </Button>
      </div>
    )
    ...
    <div className="h-full flex flex-col">
      ...
      {loadingStages ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center text-muted-foreground space-y-3">
          ...
          <Button size="sm" onClick={() => navigate("/app/modules/crm/config/statuses")}>
            Configurar Etapas
          </Button>
        </div>
      ) : (
