...
import { clientsApi } from "@/api/atendimento"
import type { ClientSummary, ClientType } from "@/api/atendimento"
...
export default function ClientsPage() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      setOpen(false)
      navigate(`/app/modules/atendimento/clients/${created.id}`)
    } catch (err) {
        ...
        <div className="space-y-1.5">
          {filtered.map(client => (
            <Card
              ...
              onClick={() => navigate(`/app/modules/atendimento/clients/${client.id}`)}
            >
