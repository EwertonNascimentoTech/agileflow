...
import { clientsApi, statusConfigApi, companiesApi } from "@/api/atendimento"
import type { Client, AttendanceSummary, StatusConfig, ChannelType, Priority, ClientType, CompanySummary } from "@/api/atendimento"
