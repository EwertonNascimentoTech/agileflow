...
import { attendancesApi, clientsApi, companiesApi, tagsApi } from "@/api/atendimento"
import type { Client, ClientSummary, ChannelType, Priority, CompanySummary } from "@/api/atendimento"
...
export default function NewAttendanceDialog({
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      onOpenChange(false)
      navigate(`/app/modules/atendimento/attendances/${attendance.id}`)
    } catch (err) {
                      ...
                      {filteredClients.length === 0 ? (
                        <div className="py-3 text-center text-sm text-muted-foreground">
                          ...
                          <button
                            ...
                            onClick={() => {
                              onOpenChange(false)
                              navigate("/app/modules/atendimento/clients")
                            }}
                          >
                            Cadastrar contato
                          </button>
