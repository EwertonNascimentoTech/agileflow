...
import { funnelsApi, metricsApi, type Funnel, type FunnelMetrics, type AttendanceOverview } from "@/api/atendimento"
                ...
                <div className="space-y-1">
                  {metrics.top_opportunities.map((opp, i) => (
                    <div
                      ...
                      onClick={() => navigate(`/app/modules/atendimento/attendances/${opp.id}`)}
                    >
