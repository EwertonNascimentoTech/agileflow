...
import { followUpApi, funnelsApi, statusConfigApi } from "@/api/atendimento"
import type { FollowUpTemplate, FollowUpChannel, Funnel, StatusConfig } from "@/api/atendimento"
