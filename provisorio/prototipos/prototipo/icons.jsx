// Lucide-style icon set (matches lucide-react names used in the real code)
...
const ICONS = {
  ...
  layoutDash:    <><rect x="3" y="3" width="7" height="9" rx="1"/><rect x="14" y="3" width="7" height="5" rx="1"/><rect x="14" y="12" width="7" height="9" rx="1"/><rect x="3" y="16" width="7" height="5" rx="1"/></>,
  folder:        <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/>,
  inbox:         <><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></>,
  users:         <><circle cx="9" cy="8" r="4"/><path d="M3 21v-1a6 6 0 0 1 12 0v1"/><path d="M16 4a4 4 0 0 1 0 8M22 21v-1a6 6 0 0 0-4-5.66"/></>,
  list:          <><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><circle cx="4" cy="6" r="1"/><circle cx="4" cy="12" r="1"/><circle cx="4" cy="18" r="1"/></>,
  board:         <><rect x="3" y="3" width="7" height="18" rx="1"/><rect x="14" y="3" width="7" height="11" rx="1"/></>,
  gantt:         <><rect x="3" y="6" width="10" height="3" rx="1"/><rect x="7" y="11" width="12" height="3" rx="1"/><rect x="5" y="16" width="9" height="3" rx="1"/></>,
  ...
  git:           <><circle cx="6" cy="3" r="3"/><circle cx="6" cy="15" r="3"/><circle cx="18" cy="9" r="3"/><path d="M6 6v9"/><path d="M18 12v3a3 3 0 0 1-3 3H9"/></>,
  arrowUp:       <><path d="M7 17 17 7"/><path d="M7 7h10v10"/></>,
  flag:          <path d="M4 22V4c0-.55.45-1 1-1h13l-2.5 4L18 11H5"/>,
  ...
  building:      <><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22V12h6v10M9 6h2M13 6h2M9 10h2M13 10h2"/></>,
  ...
  form:          <><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M8 7h8M8 11h8M8 15h5"/></>,
