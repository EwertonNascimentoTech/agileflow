...
import { statusConfigApi, funnelsApi } from "@/api/crm"
import type { StatusConfig, Funnel, StageOutcome } from "@/api/crm"
      ...
      {loading ? (
        ...
        <Alert>
          <AlertDescription className="text-xs">
            Nenhum funil cadastrado. <button onClick={() => navigate("/app/modules/crm/config/funnels")} className="underline font-medium">Crie um funil</button> antes de configurar etapas.
          </AlertDescription>
        </Alert>
      ) : (
