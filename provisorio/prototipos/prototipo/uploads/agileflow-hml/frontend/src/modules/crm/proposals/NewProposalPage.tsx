...
import { proposalsApi, proposalTemplatesApi } from "@/api/crm"
import type { ProposalItemCreate, ProposalTemplate } from "@/api/crm"
import { clientsApi, companiesApi, attendancesApi } from "@/api/crm"
import type { ClientSummary, CompanySummary, AttendanceSummary } from "@/api/crm"
...
export default function NewProposalPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      navigate(`/app/modules/crm/proposals/${created.id}`, { replace: true })
    } catch (err) {
